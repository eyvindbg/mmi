...
public class TwoButtonsExample_Innerclass extends JPanel 
{   
   ...
   private JButton myButton1, myButton2, myButton3;
    ...
    public TwoButtonsExample_Innerclass()
    {
       ...
       myButton3.addActionListener(new MyButton2Action());
       add(myButton3);
    ...
    public static void main (String args[]) {
        ...
        frame.getContentPane().add(new TwoButtonsExample_Innerclass());
        frame.pack(); 
